...
# Assemble code
"$ASSEMBLER" -ffreestanding -nostdlib -march=rv32i "${WORK_DIR}/$(basename $ASM_FILE)" -Wl,--no-relax -o "$OBJ_FILE" -T "$ECE411DIR/mp4/bin/baremetal_link.ld"
